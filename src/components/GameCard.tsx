...
export function GameCard({ game, whatsappNumber }: GameCardProps) {
  ...
  return (
    <motion.div variants={item} className="group">
      <Link
        href={href}
        className="block h-full rounded-2xl bg-[var(--surface-3)] border border-white/[0.06] overflow-hidden transition-all duration-300 hover:border-[#7C3AED]/40 hover:shadow-[0_0_30px_rgba(124,58,237,0.15)] cursor-pointer focus-visible:outline-offset-4"
      >
        <motion.div
        ...
        <div className="p-5">
          <motion.h3
            className="font-[var(--font-russo)] text-lg tracking-wide text-white group-hover:text-[#A78BFA] transition-colors duration-200"
            whileHover={{ x: 3 }}
          ...
          <div className="mt-4 flex items-center gap-2">
            <motion.div
              className="flex-1 text-center py-2.5 px-4 rounded-xl bg-[#7C3AED]/10 border border-[#7C3AED]/30 text-xs font-bold text-[#A78BFA]"
              whileHover={{
            ...
            <motion.a
              ...
              className="flex-1 text-center py-2.5 px-4 rounded-xl bg-[#25D366] hover:bg-[#1ebe5a] text-white text-xs font-bold min-h-[44px] flex items-center justify-center gap-2"
